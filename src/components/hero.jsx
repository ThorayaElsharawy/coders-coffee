                ...
                <Container>
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center min-h-[850px]'>
                        <div className='relative mt-[100px] md:mt-0 space-y-24 text-[#f1dabf] p-4'>
                            <h1 className='text-7xl font-bold leading-tight ms-14'>Blvck Tumbler</h1>
                        ...
                        <div className='relative'>
                            <img src='src/assets/black.png' className='relative z-40 h-[400px] md:h-[700px] img-shadow ' />
                            <div className='absolute top-24 -right-16 rounded-full border-[20px] border-[#f19509] h-[180px] w-[180px] z-10' />
